      ...
      if (password !== passwordRepeat) {
        ...
        if (avatarFilesTaget) {
          formdata.append(
            'avatar',
            avatarFilesTaget,
            'http://localhost:3001/user-static/' + avatar
          );
        }
        ...
        fetch('http://localhost:3001/api/profile/edit', requestOptions)
        ...
        <div className="card text-center mt-3">
          {context.user.avatar ? (
            <img
              ...
              src={'http://localhost:3001' + context.user.avatar}
          ...
          <div className="card-body mx-auto">
            <div className="card-body mx-auto">
              <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                ...
                <button id="btnEditProfile" className="btn btn-dark mb-3">
                  Сохранить
                </button>
              </form>
            </div>
