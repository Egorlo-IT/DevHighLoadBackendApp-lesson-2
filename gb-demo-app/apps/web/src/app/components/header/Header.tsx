...
export default function Header() {
  ...
  const logOut = () => {
    ...
    fetch('http://localhost:3001/api/auth/logout', requestOptions)
  ...
  useEffect(() => {
    document.querySelectorAll('.nav-link').forEach((item: any) => {
        ...
        <Container>
          <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul className="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
              ...
              <li>
                <Link to="/news" className="nav-link text-secondary">
                  <svg
                    className="bi d-block mx-auto mb-1"
                    width="24"
                    height="24"
                ...
                <li>
                  <div className="nav-link text-secondary">
                    <img
                      ...
                      className="bi d-block mx-auto mb-1 rounded-circle"
                      width="24"
                      height="24"
                      alt="avatar"
                    />
                    <span className="text-white me-1 fw-lighter">
