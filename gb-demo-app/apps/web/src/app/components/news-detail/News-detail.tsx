...
export default function NewsDetail() {
  ...
  const getAllComments = async () => {
    const response = await fetch(
      `http://localhost:3001/api/news-comments/all/news/${id}`,
      {
        method: 'GET',
      }
    );
    if (response.ok) {
      ...
      console.log('getAllComments data:', data);
  ...
  const removeComment = (idComment: string) => {
    ...
    const url =
      'http://localhost:3001/api/news-comments/' + idComment + '/' + id;
  ...
  const saveEditMessage = (commentId: string, userId: string) => {
    ...
    if (el != null) {
      ...
      const url =
        'http://localhost:3001/api/news-comments/edit/' + commentId + '/' + id;
        ...
        <div className="card text-center">
          <div className="card-body">
            ...
            <img
              ...
              src={'http://localhost:3001' + news.cover}
              alt="cover news"
            />
